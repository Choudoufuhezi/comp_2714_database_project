...
CREATE TABLE SET_ (
    ...
    SET_CAMPUS VARCHAR(50) NOT NULL
);
...
CREATE TABLE SECTION (
    ...
    SEC_SET VARCHAR(10) NOT NULL REFERENCES SET_(SET_CODE),
...
CREATE TABLE SECTION_LAB (
    ...
    SEC_LAB_START TIMESTAMP NOT NULL,
    SEC_LAB_END TIMESTAMP NOT NULL,
    SEC_LAB_DUE TIMESTAMP NOT NULL,

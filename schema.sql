...
CREATE TABLE SECTION_LAB (
    EVENT_ID VARCHAR(20) GENERATED ALWAYS AS (SEC_CODE || '-' || 'L0' || LAB_ID::TEXT) STORED PRIMARY KEY,
    ...
    CONSTRAINT section_lab_unique UNIQUE (SEC_CODE, LAB_ID)
);
...
CREATE TABLE LAB_PROGRESS (
    PROG_ID VARCHAR(30) GENERATED ALWAYS AS (STUDENT_ID || '-' || EVENT_ID) STORED PRIMARY KEY,

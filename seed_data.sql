...
INSERT INTO LAB_PROGRESS (
  ...
  -- L01
  ('A001-L01-L01', 'L01-L01', 'A001', TRUE, 'COMPLETED', TRUE,
   ...
   8.5, 8.2, FALSE),
  ('A001-L01-L02', 'L01-L02', 'A001', TRUE, 'IN_PROGRESS', FALSE,
   'https://submit.bcit.ca/comp2714/inlab/A001-L01-L02.pdf', '2025-09-15 10:35',
   NULL, NULL,
   7.0, 6.7, FALSE),
  ('A002-L01-L01', 'L01-L01', 'A002', TRUE, 'COMPLETED', TRUE,
   ...
   8.5, 8.2, FALSE),
  ('A002-L01-L02', 'L01-L02', 'A002', TRUE, 'IN_PROGRESS', FALSE,
   'https://submit.bcit.ca/comp2714/inlab/A002-L01-L02.pdf', '2025-09-15 10:40',
   NULL, NULL,
   NULL, NULL, FALSE),
  ('A003-L01-L01', 'L01-L01', 'A003', TRUE, 'COMPLETED', TRUE,
   ...
   8.5, 8.2, FALSE),
  ('A003-L01-L02', 'L01-L02', 'A003', TRUE, 'COMPLETED', TRUE,
  ...
  -- L02
  ('B001-L02-L01', 'L02-L01', 'B001', TRUE, 'COMPLETED', TRUE,
   ...
   8.5, 8.2, FALSE),
  ('B001-L02-L02', 'L02-L02', 'B001', TRUE, 'COMPLETED', TRUE,
   ...
   7.0, 6.7, FALSE),
  ('B002-L02-L01', 'L02-L01', 'B002', TRUE, 'COMPLETED', TRUE,
   ...
   8.5, 8.2, FALSE),
  ('B002-L02-L02', 'L02-L02', 'B002', TRUE, 'IN_PROGRESS', FALSE,
   'https://submit.bcit.ca/comp2714/inlab/B002-L02-L02.pdf', '2025-09-15 14:40',
   NULL, NULL,
   NULL, NULL, FALSE),
  ('B003-L02-L01', 'L02-L01', 'B003', TRUE, 'COMPLETED', TRUE,
   ...
   8.5, 8.2, FALSE),
  ('B003-L02-L02', 'L02-L02', 'B003', TRUE, 'COMPLETED', TRUE,

...
INSERT INTO LAB_PROGRESS (
  ...
  -- L01
  ('A001-L01-L01', 'L01', 1, 'A001', TRUE, 'COMPLETED',
   ...
   8.5, 8.2, FALSE),
  ('A001-L01-L02', 'L01', 2, 'A001', TRUE, 'IN_PROGRESS',
   'https://submit.bcit.ca/comp2714/inlab/A001-L01-L02.pdf', '2025-09-15 10:35',
   NULL, NULL,
   7.0, 6.7, FALSE),
  ('A002-L01-L01', 'L01', 1, 'A002', TRUE, 'COMPLETED',
   ...
   8.5, 8.2, FALSE),
  ('A002-L01-L02', 'L01', 2, 'A002', TRUE, 'IN_PROGRESS',
   'https://submit.bcit.ca/comp2714/inlab/A002-L01-L02.pdf', '2025-09-15 10:40',
   NULL, NULL,
   NULL, NULL, FALSE),
  ('A003-L01-L01', 'L01', 1, 'A003', TRUE, 'COMPLETED',
   ...
   8.5, 8.2, FALSE),
  ('A003-L01-L02', 'L01', 2, 'A003', TRUE, 'COMPLETED',
  ...
  -- L02
  ('B001-L02-L01', 'L02', 1, 'B001', TRUE, 'COMPLETED',
   ...
   8.5, 8.2, FALSE),
  ('B001-L02-L02', 'L02', 2, 'B001', TRUE, 'COMPLETED',
   ...
   7.0, 6.7, FALSE),
  ('B002-L02-L01', 'L02', 1, 'B002', TRUE, 'COMPLETED',
   ...
   8.5, 8.2, FALSE),
  ('B002-L02-L02', 'L02', 2, 'B002', TRUE, 'IN_PROGRESS',
   'https://submit.bcit.ca/comp2714/inlab/B002-L02-L02.pdf', '2025-09-15 14:40',
   NULL, NULL,
   NULL, NULL, FALSE),
  ('B003-L02-L01', 'L02', 1, 'B003', TRUE, 'COMPLETED',
   ...
   8.5, 8.2, FALSE),
  ('B003-L02-L02', 'L02', 2, 'B003', TRUE, 'COMPLETED',
  ...
  -- L03
  ('C001-L03-L01', 'L03', 1, 'C001', TRUE, 'COMPLETED',
   ...
   8.5, 8.2, FALSE),
  ('C001-L03-L02', 'L03', 2, 'C001', TRUE, 'COMPLETED',
   ...
   7.0, 6.7, FALSE),
  ('C002-L03-L01', 'L03', 1, 'C002', TRUE, 'COMPLETED',
   ...
   8.5, 8.2, FALSE),
  ('C002-L03-L02', 'L03', 2, 'C002', TRUE, 'IN_PROGRESS',
   'https://submit.bcit.ca/comp2714/inlab/C002-L03-L02.pdf', '2025-09-16 19:40',
   NULL, NULL,
   NULL, NULL, FALSE),
  ('C003-L03-L01', 'L03', 1, 'C003', TRUE, 'COMPLETED',
   ...
   8.5, 8.2, FALSE),
  ('C003-L03-L02', 'L03', 2, 'C003', TRUE, 'COMPLETED',
  ...
  -- L04
  ('D001-L04-L01', 'L04', 1, 'D001', TRUE, 'COMPLETED',
   ...
   8.5, 8.2, FALSE),
  ('D001-L04-L02', 'L04', 2, 'D001', TRUE, 'COMPLETED',
   ...
   7.0, 6.7, FALSE),
  ('D002-L04-L01', 'L04', 1, 'D002', TRUE, 'COMPLETED',
   ...
   8.5, 8.2, FALSE),
  ('D002-L04-L02', 'L04', 2, 'D002', TRUE, 'IN_PROGRESS',
   'https://submit.bcit.ca/comp2714/inlab/D002-L04-L02.pdf', '2025-09-17 10:40',
   NULL, NULL,
   NULL, NULL, FALSE),
  ('D003-L04-L01', 'L04', 1, 'D003', TRUE, 'COMPLETED',
   ...
   8.5, 8.2, FALSE),
  ('D003-L04-L02', 'L04', 2, 'D003', TRUE, 'COMPLETED',
  ...
  -- L05
  ('E001-L05-L01', 'L05', 1, 'E001', TRUE, 'COMPLETED',
   ...
   8.5, 8.2, FALSE),
  ('E001-L05-L02', 'L05', 2, 'E001', TRUE, 'COMPLETED',
   ...
   7.0, 6.7, FALSE),
  ('E002-L05-L01', 'L05', 1, 'E002', TRUE, 'COMPLETED',
   ...
   8.5, 8.2, FALSE),
  ('E002-L05-L02', 'L05', 2, 'E002', TRUE, 'IN_PROGRESS',
   'https://submit.bcit.ca/comp2714/inlab/E002-L05-L02.pdf', '2025-09-17 14:40',
   NULL, NULL,
   NULL, NULL, FALSE),
  ('E003-L05-L01', 'L05', 1, 'E003', TRUE, 'COMPLETED',
   ...
   8.5, 8.2, FALSE),
  ('E003-L05-L02', 'L05', 2, 'E003', TRUE, 'COMPLETED',
  ...
  -- L06
  ('F001-L06-L01', 'L06', 1, 'F001', TRUE, 'COMPLETED',
   ...
   8.5, 8.2, FALSE),
  ('F001-L06-L02', 'L06', 2, 'F001', TRUE, 'COMPLETED',
   ...
   7.0, 6.7, FALSE),
  ('F002-L06-L01', 'L06', 1, 'F002', TRUE, 'COMPLETED',
   ...
   8.5, 8.2, FALSE),
  ('F002-L06-L02', 'L06', 2, 'F002', TRUE, 'IN_PROGRESS',
   'https://submit.bcit.ca/comp2714/inlab/F002-L06-L02.pdf', '2025-09-18 19:40',
   NULL, NULL,
   NULL, NULL, FALSE),
  ('F003-L06-L01', 'L06', 1, 'F003', TRUE, 'COMPLETED',
   ...
   8.5, 8.2, FALSE),
  ('F003-L06-L02', 'L06', 2, 'F003', TRUE, 'COMPLETED',
